...
// Programmatic wallet operations (uses @vencura/core internally)
const wallets = await sdk.getWallets()
// Returns: [{ id: string, address: string, chainType: ChainType }, ...]
// Same response as GET /wallets endpoint

const wallet = await sdk.createWallet({ chainType: 'evm' })
const balance = await sdk.getBalance({ chainId: 421614, chainType: 'evm' })
