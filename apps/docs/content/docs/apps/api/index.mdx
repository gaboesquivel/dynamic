...
The API uses a **blackbox Vitest testing strategy** with testnet networks. See [Testing Patterns](/docs/tooling/testing-patterns) for the complete monorepo-wide testing strategy.
...
See [API Test Documentation](./test/README.md) for app-specific test details and [Testing Patterns](/docs/tooling/testing-patterns) for the complete testing strategy.
