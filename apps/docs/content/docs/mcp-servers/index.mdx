...
description: "Guide to using Model Context Protocol (MCP) servers with Cursor Composer 1 for enhanced AI-assisted development workflows."
---

This document describes how we use Model Context Protocol (MCP) servers in our development workflow with Cursor Composer 1. This is part of our broader AI-assisted development strategy. See [ADR 012: Vencura AI Architecture](/docs/adrs/012-vencura-ai-architecture) for the complete AI-friendly architecture patterns.
...
All MCP servers are configured to use `bunx` for command execution, consistent with our project's package manager choice.
...
Vercel has made significant improvements in 2024 to support backend frameworks like Elysia:

- **Zero-configuration backend support**: Deploy Elysia and Next.js applications without manual configuration
