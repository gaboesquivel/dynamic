---
title: "@vencura/core"
description: "TypeScript SDK for the Vencura API using a contract-first approach with ts-rest."
---
...
- [Vencura API](/docs/apps/api) - Elysia-based backend implementing these API contracts (Zod-first, AI-friendly)
