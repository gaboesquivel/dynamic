...
description: "Decision to adopt Viem + Wagmi for type-safe Web3 operations, lightweight bundle size, and excellent TypeScript support across backend and frontend."
---
...
| Feature | Viem + Wagmi ✅ | Ethers.js |
|---------|-----------------|-----------|
| **Bundle size** | ✅ ~27 KB | ⚠️ ~130 KB |
| **TypeScript support** | ✅ Excellent | ✅ Good |
| **Modular imports** | ✅ Import only what you need | ⚠️ Requires tree-shaking |
| **React hooks** | ✅ Wagmi built-in | ❌ Manual setup |
| **Next.js integration** | ✅ Seamless | ⚠️ Manual |
| **Ecosystem maturity** | ⚠️ Growing | ✅ Extensive |
| **Backend support** | ✅ Good | ✅ Excellent |
