---
title: "ADR 011: Vencura API ORM Selection"
description: "Decision to use Drizzle ORM for type-safe PostgreSQL queries, lightweight design, Zod-first schema integration, and seamless Elysia integration."
---
...
- Database migrations
- Integration with Elysia framework (functional, Zod-first)
...
- **Zod-first** schema integration for type inference
...
- Large ecosystem and community
- Decorator-based syntax (less suitable for functional Elysia patterns)
- Active Record and Data Mapper patterns
- Comprehensive feature set (relations, transactions, etc.)
- Good documentation
- Supports multiple databases
- Less suitable for functional Elysia patterns
...
| **Elysia integration** | ✅ Perfect fit | ⚠️ Good | ⚠️ Less suitable | ✅ Good | ⚠️ Less suitable | ⚠️ Less suitable |
...
- Works well with Elysia's functional patterns and Zod-first validation
- Type-inferred schemas integrate seamlessly with Zod validation
...
Drizzle is integrated with the Elysia-based API through functional patterns:
...
- **Zod-first**: Schema definitions align with Zod validation patterns for consistent type safety
