---
title: "ADR 013: Vencura API Test Gas Faucet"
description: "Decision to use testnet faucet APIs for automated gas token funding in E2E tests, replacing manual wallet funding with programmatic testnet token requests."
---
...
- `bun run test:e2e` - Runs tests on Arbitrum Sepolia testnet
...
- Better error handling and integration with Vitest
