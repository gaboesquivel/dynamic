---
title: "Google Cloud Deployment Option"
description: "Documentation for Google Cloud Platform deployment option, providing enhanced control and security for production workloads (documented but not currently implemented)."
---

**Status**: ⚠️ **Documented but not currently implemented**. All systems are currently deployed on **Vercel**. See [Vercel Portability Strategy](/docs/vercel-portability) for current deployment approach.

This document describes the Google Cloud deployment option for the Vencura API, providing enhanced control, security, and extensibility for production workloads. This is documented as a potential future option ONLY if production security requirements demand it.
...
- **Cloud Run**: Serverless container platform for running the Elysia-based API
